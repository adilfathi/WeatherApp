...
import kotlinx.android.synthetic.main.list_item_next_day.view.*
import java.util.*
...
class NextDayAdapter(private val mContext: Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_item_next_day, parent, false)
